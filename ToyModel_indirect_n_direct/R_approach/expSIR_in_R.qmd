---
title: "Exponential infection model with a lockdown control using R + IPOPT"
...
This example is based on the [exponential infection model](https://github.com/epirecipes/EpiPolicies/blob/main/ToyModel_indirect_n_direct/exponentialSIR_indirect_n_direct.qmd) that compares indirect and direct optimal control methods. Here we replicate the NLP formulation of the optimal control problem solved using Interior Point Optimisation (IPOPT), but in R instead of Julia.
...
You can follow these steps below, or for more detailed installation instructions, system-specific requirements, and troubleshooting, refer to the [official COIN-OR IPOPT installation guide](https://coin-or.github.io/Ipopt/INSTALL.html):
