...
# ╔═╡ 4430a390-af8c-482f-ba1c-d55474b1dd3a
begin
...
# ╔═╡ 21d6564a-f04c-4247-b1d0-be352fc4e38c
md"
# Lockdown optimisation on an SIR model using JuMP.jl 
"

# ╔═╡ e3c657e7-9869-48c9-8312-e5445fae6e67
HTML("""
<!-- the wrapper span -->
<div>
...
# ╔═╡ 56764b87-c4fc-4afe-a287-44f2a4c1f128
md"
## Libraries
"

# ╔═╡ 4494a267-a8f6-4064-8b46-83a59ead0ab7
md"
## Functions
"

# ╔═╡ d8ca7fca-cc24-4a29-a290-92e6a9b62d62
md"
ODE system
"

# ╔═╡ 2a788d88-fa83-11ef-2b14-57a1aa700a8a
...
# ╔═╡ 11f75476-f604-450d-8c6a-8644e13c4018
md"
SIR simulation
"

# ╔═╡ 4239426c-3899-483e-a6a2-9942c45a2e73
...
# ╔═╡ 25443dd1-2f1c-4487-b714-ff1145741ce1
md"
Calculate the total number of infected at the end of simulation
"

# ╔═╡ 70f8128a-fcbd-4d92-b07a-f6b5d0f1f82a
function final_size(p, u0, t₁, dur, ss, alg)
    sol = simulate(p, u0, t₁, dur, ss, alg)
    return sol[end][3]
end;

# ╔═╡ 888072cb-388b-4408-a901-83189ee86e7d
md"
## Running the model without intervention
"

# ╔═╡ 412db79e-4d40-4d8c-a98f-bb84bf9316e4
md"
Parameters
"

# ╔═╡ 69a92116-d363-4758-b6cd-c8d7d7836a45
begin
...
# ╔═╡ 717c2062-e080-4552-97d5-dae32a363db1
md"
Solve using ODEProblem
"

# ╔═╡ eeacf0d3-d2b7-44aa-866c-28c0661bd4b0
begin
	prob1 = ODEProblem(sir_ode!, u0, (t0, tf), p)
	sol1 = solve(prob1, alg, saveat=ts)
end;

# ╔═╡ fd81243d-268e-423a-b698-ef04381b5641
md"
Without control the final size of total number of cases is $\sim$ 79%
"

# ╔═╡ 64c1ad47-e0ba-4edd-bbbb-a492ca791996
println("Cumulative incidence fraction without control: ", sol1[end][3])

# ╔═╡ fcc12c2e-b860-43ab-b4cb-84ad33b3e504
plot(sol1,
     xlim=(0, 100),
     labels=["S" "I" "C"],
     xlabel="Time (days)",
...
# ╔═╡ 1021ebac-97e3-4af5-a5d8-c6216bdfda13
md"
Now find the peak value of infected individuals and the time at which it occurs:
"

# ╔═╡ b960da19-deff-4c3e-a77d-f3d087cb5f47
begin
...
# ╔═╡ e6e3cc57-876a-4351-aea8-597c389a3ef4
md"
## Running the model with intervention initiated at the peak of infected cases
"

# ╔═╡ e459fa3c-b969-4f56-b928-01d0dd859f69
md"
Demonstrating the impact of an intervention initiated at the peak of infected cases.\
Parameters:
"

# ╔═╡ 184e3f5d-1d93-4954-b784-58fc599f2560
begin
	p2 = copy(p)
...
# ╔═╡ c434e397-4ae1-4151-ab1f-678c6c5fe4b9
begin
	plot(sol2,
	     xlim=(0, 100),
	     labels=["S" "I" "C"],
...
# ╔═╡ 4113b755-6ba1-42b1-b183-0a06ca32a575
md"
## Searching for the optimal intervention time
"

# ╔═╡ a5bd0076-ab8b-4d88-b462-b8d5332a5a4f
md"
Parameters:
"

# ╔═╡ 01d43cf9-d32d-41bb-a392-f4c7c46f1eaf
begin
	β = p2[1]
	γ = p2[2]
	υ_max = p2[3]
...
# ╔═╡ 3c464974-be26-43bb-83a8-4fda5437e661
md"
Optimiser setup
" 

# ╔═╡ 557456fa-26dc-44e5-8762-afed7b04d341
begin
...
# ╔═╡ ceaed587-a9a5-42b6-9292-552baf16ac97
md"
Variables:
"

# ╔═╡ 4e882ff5-f182-4a34-82bd-535e435c888b
begin
...
# ╔═╡ 641b597d-f0d0-4be4-9df4-aa1e5de27c6b
md"
We can discretise the SIR model using different metods, but here we use a simple Euler discretisation:
"

# ╔═╡ f4c3d561-7ade-4cb6-8930-b5609fe6df8f
...
# ╔═╡ ef90f265-fbe2-4703-b715-ef7f0349b31e
...
# ╔═╡ bf61bfbe-44f9-4bc5-82cb-a852a751847b
@objective(model, Min, C[T+1]);

# ╔═╡ 43926a14-c793-4e45-92f9-1f6bbc4c9272
begin
	if silent
    	set_silent(model)
	end
...
# ╔═╡ 75a3904c-5411-4c2d-b91c-71dd1dfa37bd
termination_status(model)

# ╔═╡ d4de0dc6-6c40-470e-8eba-e130eb18530d
begin
	S_opt = value.(S)
	I_opt = value.(I)
	C_opt = value.(C)
...
# ╔═╡ 4c07a7e0-43fe-459e-b521-62619463fed2
md"
...
# ╔═╡ 32bb1f14-0d66-4dbb-ab0f-3b2579ea0165
begin
...
# ╔═╡ 722bc5a0-3fa8-4635-8344-27334ba6d437
begin
	tolerance = 1e-3
...
# ╔═╡ 9b3c8725-074c-459f-a955-ae05c90df520
begin
	t_opt = max_times[1]
...
manifest_format = "2.0"
project_hash = "760bfa2bfbd8fd0cc571fdfa2104f0fe1ca7cfb2"
...
git-tree-sha1 = "636f8ec9af1abddd469367d5f418b1169cb70726"
