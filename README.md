...
- [SIR model with optimal lockdown timing and intensity](https://github.com/epirecipes/EpiPolicies/blob/main/NPIs/Lockdown/SIR_lockdown_JuMP.md)
    This example is used to demostrate implementations across multiple optimisation frameworks:
